			...
			<head>
				<script
					...
					dangerouslySetInnerHTML={{
						__html: `(function(){var d=document.documentElement,t=localStorage.getItem('domus-theme')||'light';if(t==='system'){t=matchMedia('(prefers-color-scheme:dark)').matches?'dark':'light'}d.setAttribute('data-theme',t);var s=localStorage.getItem('domus-theme-seed');if(s)d.setAttribute('data-seed-hue',s);var c=localStorage.getItem('domus-theme-chroma');if(c)d.setAttribute('data-chroma-scale',c)})()`,
					}}
				/>
			</head>
