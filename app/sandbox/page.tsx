...
// -- Lucide Icons --
// All Lucide icons — spread into scope so generated code can use any icon by PascalCase name
...
// All icons available via the `icons` import above — spread into scope below
...
export default function SandboxPage() {
	...
	const scope = useMemo(
		() => ({
			// All Lucide icons FIRST — so UI components with the same name (e.g. Sheet)
			// take precedence when spread after
			...icons,
			...
			// UI Components (override any icon with the same name)
			Button,
			Input,
			Slider,
			Switch,
